      ...
      <div className="w-full">
        ...
        <div className="bg-sky-400">
          ...
          <p className="text-white">
            ...
            Yura, Yurchyk... whatever. I'm into a lot of different stuff and
            love cats😺. You can find me in a forest, ∄, or hardcore mosh pit.
            Write me if you need a business card site like this or any web
            application.
          </p>
          <a
